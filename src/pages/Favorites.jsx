...
import { getFavoriteSnippets } from "../store/slice/snippetSlice";
...
const Favorites = () => {
  ...
  const { favoriteSnippets, loading, error } = useSelector(
    (state) => state.snippet
  );

  useEffect(() => {
    dispatch(getFavoriteSnippets());
  }, [dispatch]);
      ...
      <div className="container mx-auto py-6 px-4 md:px-6 max-w-7xl relative z-10">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-400 mt-1">
            Your saved code snippets for quick access
          </p>
        </div>
          ...
          <Card className="border-dashed border-gray-800 bg-black/40 backdrop-blur-sm">
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-400 text-center mb-6 max-w-md">
                Mark snippets as favorites to access them quickly from here.
              </p>
